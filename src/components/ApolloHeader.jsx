    ...
    <header className="w-full fixed top-0 left-0 z-30 bg-white/80 backdrop-blur border-b border-gray-200">
      <div className="max-w-6xl mx-auto px-4 py-2 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 rounded bg-emerald-600" />
        ...
        <div className="hidden md:flex items-center gap-6 text-sm text-gray-700">
          ...
          <a className="hover:text-emerald-600" href="#highlights">Highlights</a>
          <button className="hover:text-emerald-600" onClick={() => onNavigate('apply')}>Apply</button>
        </div>
