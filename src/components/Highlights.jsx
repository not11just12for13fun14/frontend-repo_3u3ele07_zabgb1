...
export default function Highlights() {
  return (
    <section className="py-12 md:py-16 bg-gradient-to-b from-white to-indigo-50/40">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((s) => (
            <div key={s.title} className="rounded-xl border border-indigo-100 bg-white shadow-sm p-6 hover:shadow-md transition">
              <div className="flex items-center gap-3">
                <s.icon className="h-6 w-6 text-indigo-700" />
                <div>
